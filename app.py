...
menu = st.sidebar.selectbox("Navigate To", ["Predict Revenue", "Performance Insights", "Platform Analysis"])
...
if menu == "Predict Revenue":
    ...
    try:
        ...
        if submit:
            ...
            input_row.loc[0, 'Impressions'] = imp
            input_row.loc[0, 'Clicks'] = clk
            input_row.loc[0, 'Cost_INR'] = budget
            input_row.loc[0, 'Conversions'] = conv
            input_row.loc[0, 'CTR_%'] = ctr
            input_row.loc[0, 'Conversion_Rate_%'] = cr
            input_row.loc[0, 'Month'] = 1
            input_row.loc[0, 'DayOfWeek'] = 0
            input_row.loc[0, 'Day'] = 1
...
elif menu == "Performance Insights":
